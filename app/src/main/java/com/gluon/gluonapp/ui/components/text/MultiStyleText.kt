...
fun MultiStyleText(
    ...
    Text(
        buildAnnotatedString {
            withStyle(style = SpanStyle(color = finalStartColor, fontFamily = startTxtFont , fontWeight = startTxtFontWeight)) {
                append(startText)
            }
            withStyle(style = SpanStyle(color = finalEndColor
                , fontFamily = endTxtFont, fontWeight = endTextFontWeight)
            ) {
                append(endText)
            }
        },
